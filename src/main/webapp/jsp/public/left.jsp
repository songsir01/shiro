...
#Menu .level1 .level1Style {
  background: url("/jsp/public/style/images/img/menu_btn_bg.gif") no-repeat scroll 0 0 transparent;
    height: 23px;
    padding-left: 20px;
    padding-top: 5px;
    width: 135px;
...
#Menu .level1 .MenuLevel2 .level2Style{
	...
	padding-top: 5px;
	width: 112px;
	background-image:url(/jsp/public/style/images/img/menu_arrow_single.gif);
    ...
    <ul id="Menu">
	    <li class="level1">
            <div onClick="menuClick(this);" class="level1Style">
				<img src="<%=request.getContextPath() %>/jsp/public/style/images/func20001.gif" class="Icon" /> 
				系统菜单
			</div>
            <ul class="MenuLevel2">
            
            	<shiro:hasPermission name="用户管理">
            	<li class="level2 level2Style"  name="menuLi">
            	...
            	<li class="level2 level2Style"  name="menuLi">
                    <a target="right" href="">商品管理</a>
				</li>
				</shiro:hasPermission>
            	<shiro:hasPermission name="权限管理">
            	<li class="level2 level2Style"  name="menuLi">
                    <a target="right" href="">权限管理</a>
				</li>
				</shiro:hasPermission>
            	<shiro:hasPermission name="个人中心">
            	<li class="level2 level2Style"  name="menuLi">
                    <a target="right" href="">个人中心</a>
				</li>
				</shiro:hasPermission>
