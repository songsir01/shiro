...
<script type="text/javascript" src="/jsp/public/style/js/page_common.js"></script>
<link href="/jsp/public/style/css/common_style_blue.css" rel="stylesheet" type="text/css">
<link rel="/jsp/public/stylesheet" type="text/css" href="style/css/index_1.css" />
</head>
			...
			<tbody id="TableData">
				<c:forEach items="${roleList }" var="list">
					<tr class="TableDetail1" style="background: #DCDCDC"
						...
						<c:forEach items="${list.modules }" var="plist">
							<input type="checkbox" value="${plist.mid }" checked="checked" disabled="disabled"/>${plist.mname } &nbsp;
						</c:forEach>
				...
				<div class="modal-body ">
					<form class="form-horizontal" role="form" id="form">
						...
						<div style="margin-left: 150px">
							...
							<c:forEach items="${roleList }" var="list">
								<c:forEach items="${list.modules }" var="mlist">
									<input type="checkbox" name="up_pname" value="2" ><span style="font-size: medium;">${mlist.mname }</span>&nbsp;
								</c:forEach>
							</c:forEach>
