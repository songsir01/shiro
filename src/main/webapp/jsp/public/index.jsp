...
<title>练习一下管理系统</title>
	...
	<frameset rows="100px,*" framespacing="0" border="0" frameborder="0">
		<frame src="jsp/public/top.jsp" scrolling="no" noresize /> 
		<frameset cols="178px,*">
			<frame noresize src="jsp/public/left.jsp" scrolling="yes" /> 
			<frame noresize name="right" src="jsp/public/right.jsp" scrolling="yes" /> 
		</frameset>
	</frameset>
	<noframes>
		<body onload="isLogin()">
